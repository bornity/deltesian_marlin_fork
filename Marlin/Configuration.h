...
#define STRING_CONFIG_H_AUTHOR "(bornity, 1.1.x.1_Deltesian Branch)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Deltesian"
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 223.0 // mm
...
#define DELTESIAN
  ...
  // Skip segmentation of linear moves on the Y axis
  // Warning: Not compatible with most forms of software bed leveling!
  #define DELTESIAN_SKIP_Y_SEGMENTS
...
#define DEFAULT_ZJERK                 DEFAULT_XJERK // XZ the Same for Deltesian
...
#define Y_BED_SIZE (-(MANUAL_Y_HOME_POS) * 2)
...
#define Y_BED_MIN_POS (MANUAL_Y_HOME_POS)
#define Y_BED_MAX_POS -(MANUAL_Y_HOME_POS)
